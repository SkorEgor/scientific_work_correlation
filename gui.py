...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.plotWindow_error_and_threshold = QtWidgets.QWidget(Dialog)
        self.plotWindow_error_and_threshold.setObjectName("plotWindow_error_and_threshold")
        self.plotLayout2 = QtWidgets.QVBoxLayout(self.plotWindow_error_and_threshold)
        self.plotLayout2.setObjectName("plotLayout2")
        self.verticalLayout_4.addWidget(self.plotWindow_error_and_threshold)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.label_text_width_correlation = QtWidgets.QLabel(Dialog)
        self.label_text_width_correlation.setObjectName("label_text_width_correlation")
        self.horizontalLayout_2.addWidget(self.label_text_width_correlation)
        self.lineEdit_correlation_width = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_correlation_width.setMaxLength(5)
        self.lineEdit_correlation_width.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_correlation_width.setObjectName("lineEdit_correlation_width")
        self.horizontalLayout_2.addWidget(self.lineEdit_correlation_width)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_filter_frequency_end.setText(_translate("Dialog", "22345"))
        ...
        self.label_text_width_correlation.setText(_translate("Dialog", "Ширина окна  корреляции"))
        self.lineEdit_correlation_width.setText(_translate("Dialog", "10"))
        self.pushButton_signal_difference.setText(_translate("Dialog", "Корреляция"))
        self.label_text_threshold_value.setText(_translate("Dialog", "Пороговое значение (%):"))
        self.lineEdit_threshold.setText(_translate("Dialog", "0"))
